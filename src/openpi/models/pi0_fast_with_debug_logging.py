    ...
    def sample_actions(
        ...
        *,
        ...
        def step(carry):
            ...
            jax.debug.print("THIS IS MY FAST ARROW LEN {fast_arrow_len}", fast_arrow_len=fast_arrow_len)
        ...
        if return_debug:
            # These are still JAX arrays here. Convert to NumPy / lists in the policy-server layer
